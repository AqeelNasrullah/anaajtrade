...
@section('breadcrumbs')
    {{ Breadcrumbs::render('add_rice_stock', $profile) }}
@endsection
...
@section('content')
    <section class="container-fluid py-3">
        <div class="row">
            ...
            <main class="col-md-9">
                <h1 class="text-success fw-900 text-center mb-3">Add Rice Stock / <span class="text-urdu-kasheeda">چاول کا اسٹاک شامل کریں</span></h1>
                <div style="max-width:700px;margin:0px auto;">
                    @include('components.error')
                    <form action="{{ route('riceStock.store', base64_encode(($profile->id * 123456789) / 12098)) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
