<div class="p-3" style="border-radius: 5px;background-color: lightgray;position: sticky; top: 15px;z-index: 100;">
    <div class="mx-auto mb-2" style="width: 115px;height: 115px;border-radius: 100%;overflow: hidden;"><img src="{{ asset('images/dps/'.$profile->avatar) }}" alt="Image not found" width="100%"></div>
    <div>
